var locations = {
    ...
    fleatownOH: new Location("Fleatown, OH", "fleatownOH.png", "",
    ...
    hellMI: new Location("Hell, MI", "hellMI.png", "",
        new LocationDetails("fleatownOH.png", "72", 
            [
                ...
                "An infinite supply of puns: <a href='https://gotohellmi.com'>gotohellmi.com</a> "
            ])),
    looneyvilleTX: new Location("Looneyville, TX"),
    boogertownNC: new Location("Boogertown, NC"),
    spreadEagleWI: new Location("Spread Eagle, WI")
};
